...
```{r descriptives statistics, include=FALSE}
unique(c(Leads_df))
dim(Leads_df)
summary(Leads_df)
```
...
```{r plot for missing data, echo=FALSE}
...
```{r categorical variable vs target variable, echo=FALSE}
...
```{r inferential statistics, echo=FALSE}
